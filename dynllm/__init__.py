...
포함 레이어:
  ...
  --  memory_rank_adapter   MemoryGraph — PageRank 기억 재정렬 (Phase G)
  --  diagnostics           ConvergenceMonitor, EntropyAnalyzer, IntegrationDiagnostic (Phase G)
"""
__version__ = "0.6.0"
__codename__ = "Phase A-G — Foundation + Engine Hub Integration"
